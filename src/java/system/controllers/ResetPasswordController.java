...
public class ResetPasswordController extends HttpServlet {
    ...
    private static final String FAIL = "forget.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String reset = request.getParameter("txtReset");
            String check = request.getParameter("txtResetCheck");
            if (reset.equals(check)) {
                ...
                request.setAttribute("RESET", check);
                request.setAttribute("USERNAME", username);
                request.setAttribute("WARN", "Invalid Verification Code. Please Try Again");
            }
        } catch (Exception e) {
            LOGGER.error("Error at ResetPasswordController: " + e.getMessage());
        } finally {
