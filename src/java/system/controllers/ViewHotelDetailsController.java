 ...
 * @author Admin
 */
public class ViewHotelDetailsController extends HttpServlet {

    private static final Logger LOGGER = Logger.getLogger(ViewHotelDetailsController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("ROOM", room.getRoomByHotelID(hotelID, in, out));
        } catch (Exception e) {
            LOGGER.error("Error at ViewHotelDetailsController: " + e.getMessage());
        } finally {
