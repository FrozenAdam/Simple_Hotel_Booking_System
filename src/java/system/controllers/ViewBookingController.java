...
public class ViewBookingController extends HttpServlet {
    ...
    private static final Logger LOGGER = Logger.getLogger(ViewBookingController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<BookingDTO> result = dao.getAllBookingByUsername(user.getUsername());
            request.setAttribute("LIST", result);
        } catch (Exception e) {
            LOGGER.error("Error at ViewBookingController: " + e.getMessage());
        } finally {
