...
import system.utility.VerifyRecaptcha;
...
public class LoginController extends HttpServlet {
    ...
    private static final String MAIN = "GetHotelController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (verify == false) {
                request.setAttribute("ERRORNOTE", "Invalid Captcha, Please Try Again.");
            } else if (dto == null || dto.getStatus() == -1) {
