...
public class RegistrationDAO implements Serializable {
    ...
    public RegistrationDTO checkLogin(String user, String pass) throws Exception {
        ...
        try {
            openConnection();
            String sql = "SELECT Username, Fullname, Phone, Address, CreatedDate, RoleID, StatusID FROM Accounts WHERE Username = ? and Password = ?";
    ...
    public boolean registerAccount(RegistrationDTO dto) throws Exception {
        ...
        try {
            openConnection();
            String sql = "INSERT INTO Accounts(Username, Password, Fullname, Phone, Address, CreatedDate, RoleID, StatusID) VALUES (?, ?, ?, ?, ?, GETDATE(), ?, ?)";
            preStm = con.prepareStatement(sql);
